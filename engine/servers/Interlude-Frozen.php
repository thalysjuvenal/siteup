...
$config["QUERY_SELECT_ITEM_STATS_AUGMENTATIONS"] = "SELECT * FROM augmentations WHERE item_id = ?";
$config["QUERY_UPDATE_ITEM_STATS_AUGMENTATIONS"] = "UPDATE augmentations SET item_id = ? WHERE item_id = ?";
...
$config["QUERY_ITEMS_DETAILS_1"] = "SELECT i.*, t.itemGrade FROM items AS i, icp_icons_interlude AS t WHERE i.item_id = t.itemId AND i.object_id = ? AND i.owner_id = ? AND (SELECT online FROM characters WHERE obj_Id = i.owner_id) = '0' AND (SELECT account_name FROM characters WHERE obj_Id = i.owner_id) = ?";
...
$config["QUERY_SELECT_ITEM_TO_ENCHANT"] = "SELECT i.*, (SELECT itemGrade FROM icp_icons_interlude WHERE itemId = i.item_id) AS itemGrade FROM items AS i, characters AS c WHERE i.owner_id = c.obj_Id AND i.object_id = ? AND c.obj_Id = ? AND c.account_name = ?";
...
$config["QUERY_UPDATE_CHARACTER_NAME_OLYMPIADS"] = "UPDATE olympiad_nobles SET char_name = ? WHERE charId = ?";
...
$config["QUERY_RANKING_RAIDPOINTS"] = "SELECT c.*, (SELECT SUM(points) FROM character_raid_points WHERE charId = c.obj_Id) AS raid_points, IF((SELECT clan_name FROM clan_data WHERE clan_id = c.clanid) IS NULL, 'n/a', (SELECT clan_name FROM clan_data WHERE clan_id = c.clanid)) AS clan FROM characters AS c WHERE c.accesslevel = '0' ORDER BY raid_points DESC, char_name ASC LIMIT {MAX_LIMIT}";
$config["QUERY_RANKING_OLYMPIADS"] = "SELECT o.*, (SELECT clanid FROM characters WHERE obj_Id = o.charId) AS clanid, (SELECT char_name FROM characters WHERE obj_Id = o.charId) AS char_name, IF((SELECT clan_name FROM clan_data WHERE clan_id = (SELECT clanid FROM characters WHERE obj_Id = o.charId)) IS NULL, 'n/a', (SELECT clan_name FROM clan_data WHERE clan_id = (SELECT clanid FROM characters WHERE obj_Id = o.charId))) AS clan FROM olympiad_nobles AS o WHERE (SELECT accesslevel FROM characters WHERE obj_Id = o.charId) = '0' AND o.competitions_done > '8' ORDER BY o.class_id ASC, o.olympiad_points DESC, o.competitions_done ASC, char_name ASC";
$config["QUERY_RANKING_HEROES_1"] = "SELECT h.count, (SELECT clanid FROM characters WHERE obj_Id = h.charId) AS clanid, (SELECT base_class FROM characters WHERE obj_Id = h.charId) AS base, (SELECT char_name FROM characters WHERE obj_Id = h.charId) AS char_name, IF((SELECT clan_name FROM clan_data WHERE clan_id = (SELECT clanid FROM characters WHERE obj_Id = h.charId)) IS NULL, 'n/a', (SELECT clan_name FROM clan_data WHERE clan_id = (SELECT clanid FROM characters WHERE obj_Id = h.charId))) AS clan, IF((SELECT ally_name FROM clan_data WHERE clan_id = (SELECT clanid FROM characters WHERE obj_Id = h.charId)) IS NULL, 'n/a', (SELECT ally_name FROM clan_data WHERE clan_id = (SELECT clanid FROM characters WHERE obj_Id = h.charId))) AS ally FROM heroes AS h WHERE (SELECT accesslevel FROM characters WHERE obj_Id = h.charId) = '0' ORDER BY h.count DESC, char_name ASC LIMIT {MAX_LIMIT}";
$config["QUERY_RANKING_HEROES_2"] = "SELECT h.count, (SELECT clanid FROM characters WHERE obj_Id = h.charId) AS clanid, (SELECT base_class FROM characters WHERE obj_Id = h.charId) AS base, (SELECT char_name FROM characters WHERE obj_Id = h.charId) AS char_name, IF((SELECT clan_name FROM clan_data WHERE clan_id = (SELECT clanid FROM characters WHERE obj_Id = h.charId)) IS NULL, 'n/a', (SELECT clan_name FROM clan_data WHERE clan_id = (SELECT clanid FROM characters WHERE obj_Id = h.charId))) AS clan, IF((SELECT ally_name FROM clan_data WHERE clan_id = (SELECT clanid FROM characters WHERE obj_Id = h.charId)) IS NULL, 'n/a', (SELECT ally_name FROM clan_data WHERE clan_id = (SELECT clanid FROM characters WHERE obj_Id = h.charId))) AS ally FROM heroes AS h WHERE h.played='1' AND (SELECT accesslevel FROM characters WHERE obj_Id = h.charId) = '0' ORDER BY base ASC";
$config["QUERY_RANKING_CLANS"] = "SELECT c.clan_name, c.clan_level, (c.clan_id) AS clanid, c.reputation_score, IF((c.ally_name) IS NULL, 'n/a', (c.ally_name)) AS ally_name, (SELECT char_name FROM characters WHERE obj_Id = c.leader_id) AS leader, (SELECT SUM(pvpkills) FROM characters WHERE clanid = c.clan_id) AS toppvp FROM clan_data AS c WHERE (SELECT accesslevel FROM characters WHERE obj_Id = c.leader_id) = '0' ORDER BY ? LIMIT {MAX_LIMIT}";
...
$config["QUERY_GET_CHARACTER_ITEMS_1"] = "SELECT *, (SELECT char_name FROM characters WHERE obj_Id = i.owner_id) AS char_name FROM items AS i, icp_icons_interlude AS m WHERE i.item_id=m.itemId AND i.owner_id = ? AND (SELECT account_name FROM characters WHERE obj_Id = i.owner_id) = ? AND (SELECT online FROM characters WHERE obj_Id = i.owner_id) = '0' AND m.itemType IN('Armor','Weapon') AND i.loc IN('PAPERDOLL','INVENTORY','WAREHOUSE') AND m.itemDrop='true' AND m.itemSell='true' AND m.itemTrade='true' AND enchant_level >= '0' AND itemGrade != ''{WHERE_PVP} AND i.loc IN('{LOC}') ORDER BY m.itemId ASC";
$config["QUERY_GET_CHARACTER_ITEMS_2"] = "SELECT *, (SELECT char_name FROM characters WHERE obj_Id = i.owner_id) AS char_name FROM items AS i, icp_icons_interlude AS m WHERE i.item_id = m.itemId AND owner_id = ? AND i.loc IN('{LOC}') AND (SELECT account_name FROM characters WHERE obj_Id = i.owner_id) = ? ORDER BY m.itemId ASC";
